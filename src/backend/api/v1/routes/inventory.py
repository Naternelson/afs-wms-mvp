...
from src.backend.schemas.inventory import InventoryCreate, InventoryRead, InventoryUpdate
...
def update_inventory_item(inventory_id: int, item: InventoryUpdate, db: Session = Depends(get_db)):
